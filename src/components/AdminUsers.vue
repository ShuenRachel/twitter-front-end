      ...
      <div class="user-card__info">
        ...
        <div class="user-card__info__actives">
          ...
          <div class="user-card__info__actives__likeCount">
            ...
            <span class="user-card__info__actives__count">{{ user.TweetsLikedCount }}</span>
          </div>
        </div>
        <div class="user-card__info__follow">
          <span>
            <span class="user-card__info__follow__count">{{ user.FollowingsCount }} 個</span>跟隨中
          </span>
          <span>
            <span class="user-card__info__follow__count">{{ user.FollowersCount }} 位</span>跟隨者
          </span>
        </div>
      </div>
    </div>
     ...
     div.user-card {
      ...
      &__info {
        ...
        &__follow {
          ...
          font-size: 14px;
          font-weight: 400;
          span.user-card__info__follow__count{
            font-weight: 500;
            color: $text-main;
          }
        }
